...
const Ict = () => {
    ...
    const ictImages = [
        { url: "https://rymec.edu.in/wp-content/uploads/2023/02/img9.jpeg", alt: "ICT Lab Equipment 1" },
        { url: "https://rymec.edu.in/wp-content/uploads/2023/02/img10-scaled.jpg", alt: "ICT Lab Faculty/Staff 2" }
    ];
            ...
            <div className="bg-white border-b border-gray-100 py-4">
                <div className="container mx-auto px-4 md:px-8">
                    <nav className="flex text-sm font-medium text-gray-500">
                        ...
                        <span className="text-cu-blue">Information & Communication Technology (ICT)</span>
                    </nav>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        >
                            <div className="space-y-4 mb-10">
                                <h2 className="text-3xl font-bold text-gray-800 tracking-tight">ICT Facilities</h2>
                                <div className="w-16 h-1 bg-cu-gold"></div>
                                <p className="text-gray-600 leading-relaxed">
                                    RYMEC provides state-of-the-art Information and Communication Technology (ICT) infrastructure to support innovative teaching, research, and incubation activities. Our labs are equipped with the latest technology to foster a digital-first learning environment.
                                </p>
                            </div>

                            <div className="space-y-10">
                                {ictImages.map((img, idx) => (
                                    <motion.div
                                        key={idx}
