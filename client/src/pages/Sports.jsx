...
const Sports = () => {
    ...
    const sportsImages = [
        { url: "https://rymec.edu.in/wp-content/uploads/2023/02/img1.jpeg", alt: "Sports Achievement 1" },
        { url: "https://rymec.edu.in/wp-content/uploads/2023/02/img2.jpeg", alt: "Sports Event 2" },
        { url: "https://rymec.edu.in/wp-content/uploads/2023/02/img3.jpeg", alt: "Sports Facility 3" },
        { url: "https://rymec.edu.in/wp-content/uploads/2023/02/img4.jpeg", alt: "Athletics 4" },
        { url: "https://rymec.edu.in/wp-content/uploads/2023/02/img5.jpeg", alt: "Team Sports 5" }
    ];
            ...
            <div className="bg-white border-b border-gray-100 py-4">
                <div className="container mx-auto px-4 md:px-8">
                    <nav className="flex text-sm font-medium text-gray-500">
                        ...
                        <span className="text-cu-blue">Sports</span>
                    </nav>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        >
                            <div className="space-y-4 mb-10">
                                <h2 className="text-3xl font-bold text-gray-800 tracking-tight">Physical Education & Sports</h2>
                                <div className="w-16 h-1 bg-cu-gold"></div>
                                <p className="text-gray-600 leading-relaxed text-lg">
                                    RYMEC recognizes the importance of physical fitness and sports in the overall development of students. Our campus provides extensive facilities for both indoor and outdoor sports.
                                </p>
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="p-6 bg-blue-50/50 rounded-2xl border border-blue-100">
                                    <h3 className="text-xl font-bold text-cu-blue mb-4 flex items-center gap-2">
                                        <div className="w-2 h-2 bg-cu-blue rounded-full"></div>
                                        Outdoor Sports
                                    </h3>
                                    <ul className="space-y-2 text-gray-700 font-medium">
                                        ...
                                        <li>• Throwball Court</li>
                                    </ul>
                                </div>
                                <div className="p-6 bg-gold-50/50 rounded-2xl border border-gold-100">
                                    <h3 className="text-xl font-bold text-cu-gold mb-4 flex items-center gap-2">
                                        <div className="w-2 h-2 bg-cu-gold rounded-full"></div>
                                        Indoor Sports
                                    </h3>
                                    <ul className="space-y-2 text-gray-700 font-medium">
                                        <li>• Table Tennis</li>
