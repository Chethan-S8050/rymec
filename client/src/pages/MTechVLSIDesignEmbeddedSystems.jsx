...
const MTechVLSIDesignEmbeddedSystems = () => {
    ...
    const faculty = [
        { name: "Dr. Savita Sonoli", role: "Professor & Head (E&CE)", img: "/assets/images/mtech_vlsi/faculty/savita.jpg" }, // Assuming asset exists or using placeholder
    ];
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
                        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col md:flex-row gap-8 items-start">
                            <div className="w-full md:w-1/3 flex-shrink-0">
                                <img
                                    src="/assets/images/mtech_vlsi/faculty/savita.jpg"
                                    alt="Professor"
                                    className="w-full h-auto rounded-lg shadow-md object-cover"
                                />
                                <div className="mt-4 text-center">
                                    <h3 className="font-bold text-lg text-cu-blue">M.Tech VLSI & ES</h3>
                            ...
                            <div className="w-full md:w-2/3">
                                ...
                                <p className="text-gray-600 leading-relaxed mb-4">
                                    The M.Tech in VLSI Design & Embedded Systems is offered by the Department of Electronics & Communication Engineering. This program provides advanced training in VLSI design, testing, verification, and embedded systems, preparing students for the fast-growing semiconductor and electronics industries.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-bold text-gray-800 mb-2">VLSI Design Lab</h4>
                                <p className="text-gray-600">Advanced EDA tools for chip design, simulation, and verification.</p>
                            </div>
                            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-bold text-gray-800 mb-2">Embedded Systems Lab</h4>
                                <p className="text-gray-600">Equipped with hardware kits (ARM, FPGA) for embedded system development.</p>
                            </div>
                        </div>
                    </motion.div>
                );
                    ...
                    <div className="w-full lg:w-1/4 flex-shrink-0">
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-28">
                            <div className="p-6 bg-cu-blue text-white">
                                ...
                                <p className="text-blue-100 text-sm mt-1">M.Tech (VLSI & ES)</p>
                            </div>
                            <nav className="p-2">
...
export default MTechVLSIDesignEmbeddedSystems;
